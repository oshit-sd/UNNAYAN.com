...
<div class="msgMDCreateArea">
   ...
   <?php
	$count = $this->db->from("about_us")->count_all_results();
	  	if ($count == 1) :	
			if (isset($fatchAllData)) :
			  	foreach ($fatchAllData as $data) :
	  ?>
    <div class="committeeSave">
        <form action="<?php echo base_url();?>About_update/<?php echo $data->id; ?>" class="form-horizontal" enctype="multipart/form-data" method="post">
    ...
    <div class="committeeSave">
        <form action="<?php echo base_url();?>saveAbout" class="form-horizontal" enctype="multipart/form-data" method="post">
