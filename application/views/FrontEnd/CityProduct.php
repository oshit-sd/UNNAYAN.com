      ...
      <div class="col-md-9 p-0" style="">
        ...
        <div class="row" style="">
          ...
          <div class="col-xs-9" style="margin-top: -20px;">
             <form method="post" action="<?php echo base_url(); ?>SearchProduct/<?php echo $id; ?>">
        ...
        <div class="row" style="">
          <div class="col-xs-12"  style="margin-top: 20px;">
            <span style="font-size: 14px; font-weight: bold; color: #000;" style="float: left;">Zone: </span>
            <?php
             $uType = $this->session->userdata('user_type');
             if($uType): $uType = $uType; else: $uType = 0; endif;
               if (isset($fatchArea)) :
                    foreach ($fatchArea as $zone) :
                      if($zone->city_id == $city):

                      $zID  = $zone->ar_id;
                      $zid = strtr(base64_encode($zID), '+/=', '_-.'); 

                      $cID  = $zone->cty_id;
                      $cid = strtr(base64_encode($cID), '+/=', '_-.'); 
            ?>
                <a class="Bbutton" href="<?php echo base_url(); ?>ZoneProduct/<?php echo $zid; ?>/<?php echo $uType; ?>/<?php echo $cid; ?>/<?php echo $zone->area_name; ?>"><?php echo $zone->area_name; ?></a>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-8" style="margin-top: 20px;">
              <div class="product-listing">
                ...
                <?php
                    if (isset($CityProduct)) :
                    foreach ($CityProduct as $data) :
                      if($data->p_status == 'p' || $data->p_status == 'a'):
                         foreach($accessCategory as $category): 
                           if($data->p_category == $category->cat_id):
                  ...
                  <div class="col-md-3 col-xs-6 plr-20" >
                    <div class="product-item" style="border:1px solid #e9e9e9;">
                      ...
                      <div class="product-item-details" style=" margin-bottom: 0px;">
                        ...
                        <div class="price-box"> 
                          <span class="price" style="padding: 10px;"><?php echo number_format($data->p_price); ?>
                            <?php
