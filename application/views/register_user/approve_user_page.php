...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Approve User</li>
    </ol>
</section>
<hr>
             ...
             ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-toggle="tooltip" href="<?php echo base_url(); ?>moreCategoryAccess/<?php echo $data->user_id; ?>" title="Add More Category Access"  class="linka fancybox fancybox.ajax  btn btn-xs btn-primary" ><i class="fa fa-tags" aria-hidden="true"></i></a> &nbsp;
